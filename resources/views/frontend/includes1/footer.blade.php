...
<div class="brand-area">
	<div class="container">
		<div class="row">
			<div class="col-lg-4">
				<div class="brand-add">
					<a href="#"><img src="{{URL::asset('frontend1/img/brand-logo/bl5.png')}}" alt="brand-logo"></a>
				</div>
			</div>
			<div class="col-lg-8">
				<!-- Brand Logo -->
				<div class="brand-logo">
					<div id="logo-carousel" class="owl-carousel">
						<a href="#"><img src="{{URL::asset('frontend1/img/brand-logo/bl1.png')}}" alt="brand-logo"></a>
						<a href="#"><img src="{{URL::asset('frontend1/img/brand-logo/bl2.png')}}" alt="brand-logo"></a>
						<a href="#"><img src="{{URL::asset('frontend1/img/brand-logo/bl3.png')}}" alt="brand-logo"></a>
						<a href="#"><img src="{{URL::asset('frontend1/img/brand-logo/bl4.png')}}" alt="brand-logo"></a>
						<a href="#"><img src="{{URL::asset('frontend1/img/brand-logo/bl1.png')}}" alt="brand-logo"></a>
						<a href="#"><img src="{{URL::asset('frontend1/img/brand-logo/bl2.png')}}" alt="brand-logo"></a>
						<a href="#"><img src="{{URL::asset('frontend1/img/brand-logo/bl3.png')}}" alt="brand-logo"></a>
						<a href="#"><img src="{{URL::asset('frontend1/img/brand-logo/bl4.png')}}" alt="brand-logo"></a>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="footer-payment">
						<a href="#"><img src="{{URL::asset('frontend1/img/logo/payment.png')}}" alt=""></a>
					</div>
				</div>
			</div>
		</div>
